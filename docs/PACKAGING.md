...
```text
dist/desktop-macos/EveysGibEsuReporter-<version>-macos.dmg
```
...
```text
dist/windows-portable/EveysGibEsuReporter-<version>-windows-portable.zip
```
...
```text
dist\windows\EveysGibEsuReporter-<version>.exe
```
...
```text
dist/desktop-linux/EveysGibEsuReporter-<version>-linux.tar.gz
```
